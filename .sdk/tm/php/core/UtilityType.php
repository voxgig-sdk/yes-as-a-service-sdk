...
// YesAsAService SDK utility type

class YesAsAServiceUtility
{
    ...
    public static function copy(YesAsAServiceUtility $src): YesAsAServiceUtility
    {
        $u = new YesAsAServiceUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
