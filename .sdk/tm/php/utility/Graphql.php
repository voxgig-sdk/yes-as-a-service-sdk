...
// YesAsAService SDK utility: graphql
//
...
class YesAsAServiceGraphql
{
    ...
    // equivalent.
    public static function body(YesAsAServiceContext $ctx): mixed
    {
    ...
    public static function errors(YesAsAServiceContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
