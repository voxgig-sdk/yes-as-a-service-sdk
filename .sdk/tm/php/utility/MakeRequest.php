...
// YesAsAService SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class YesAsAServiceMakeRequest
{
    public static function call(YesAsAServiceContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new YesAsAServiceResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new YesAsAServiceResponse($fetched);
        } else {
