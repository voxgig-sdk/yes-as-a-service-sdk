...
// YesAsAService SDK ratelimit feature
...
class YesAsAServiceRatelimitFeature extends YesAsAServiceBaseFeature
{
    ...
    private function _acquire(YesAsAServiceContext $ctx): void
    {
    ...
    private function _track(YesAsAServiceContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
