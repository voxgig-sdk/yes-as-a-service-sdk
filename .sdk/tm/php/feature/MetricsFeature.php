...
// YesAsAService SDK metrics feature
...
class YesAsAServiceMetricsFeature extends YesAsAServiceBaseFeature
{
    ...
    private function _record(YesAsAServiceContext $ctx, bool $ok): void
    {
