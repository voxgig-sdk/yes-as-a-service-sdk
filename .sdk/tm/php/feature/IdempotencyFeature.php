...
// YesAsAService SDK idempotency feature
...
class YesAsAServiceIdempotencyFeature extends YesAsAServiceBaseFeature
{
    ...
    private function _mutating(YesAsAServiceContext $ctx): bool
    {
