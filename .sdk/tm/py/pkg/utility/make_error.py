...
def make_error_util(ctx, err):
    if ctx is None:
        from projectname_sdk.core.context import YesAsAServiceContext
        ctx = YesAsAServiceContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, YesAsAServiceError):
        errmsg = err.msg
    ...
    sdk_err = YesAsAServiceError("", msg, ctx)
