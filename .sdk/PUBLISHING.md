...
|---|---|---|
| `ts/` | @voxgig-sdk/yes-as-a-service-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/yes-as-a-service-sdk \
      --repository voxgig-sdk/yes-as-a-service-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/yes-as-a-service-sdk` shows it, and
`npm trust revoke @voxgig-sdk/yes-as-a-service-sdk --id=<id>` removes it.
