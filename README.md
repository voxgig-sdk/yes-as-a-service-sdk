...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/yes-as-a-service` | `npm install @voxgig-sdk/yes-as-a-service` |
| Python | `voxgig-sdk-yes-as-a-service` | `pip install voxgig-sdk-yes-as-a-service` |
| PHP | `voxgig-sdk/yes-as-a-service` | `composer require voxgig-sdk/yes-as-a-service` |
| Golang | `github.com/voxgig-sdk/yes-as-a-service-sdk/go` | `go get github.com/voxgig-sdk/yes-as-a-service-sdk/go` |
| Ruby | `voxgig-sdk-yes-as-a-service` | `gem install voxgig-sdk-yes-as-a-service` |
| Lua | `voxgig-sdk-yes-as-a-service` | `luarocks install voxgig-sdk-yes-as-a-service` |
