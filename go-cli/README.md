...
AQL-driven CLI and REPL for the YesAsAService SDK. Positional arguments are
...
```sh
go build -o yes-as-a-service-cli ./...
```
...
./yes-as-a-service-cli list yes
./yes-as-a-service-cli load 1 yes
./yes-as-a-service-cli load '{id:1}' yes
