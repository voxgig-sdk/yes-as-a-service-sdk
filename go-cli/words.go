...
func registerSDKWords(r *eng.Registry, client *sdk.YesAsAServiceSDK) {
...
func runOp(client *sdk.YesAsAServiceSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
