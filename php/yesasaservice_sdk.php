...
class YesAsAServiceSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = YesAsAServiceHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = YesAsAServiceHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!YesAsAServiceFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, YesAsAServiceFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return YesAsAServiceUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = YesAsAServiceHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = YesAsAServiceHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = YesAsAServiceHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new YesAsAServiceError($op . "_allow",
                "YesAsAServiceSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = YesAsAServiceHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new YesAsAServiceError("graphql_error",
                "YesAsAServiceSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Yes($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_yes === null) {
                $this->_yes = new YesEntity($this, null);
            }
            return $this->_yes;
        }
        return new YesEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new YesAsAServiceSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
