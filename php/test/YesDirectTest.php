...
class YesDirectTest extends TestCase
{
    public function test_direct_load_yes(): void
    {
        $setup = yes_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-yes", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
