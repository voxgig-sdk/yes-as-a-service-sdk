...
// YesAsAService SDK pipeline test
//
...
{
    private static function utility(): YesAsAServiceUtility
    {
        return new YesAsAServiceUtility();
    }
    ...
    private static function ctx(array $over = []): YesAsAServiceContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new YesAsAServiceContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new YesAsAServiceOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof YesAsAServiceError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new YesAsAServiceOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = YesAsAServiceMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new YesAsAServiceOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = YesAsAServiceMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new YesAsAServiceOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = YesAsAServiceMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new YesAsAServiceSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = YesAsAServiceMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new YesAsAServiceResponse([]),
            'result' => new YesAsAServiceResult([]),
        ]);
        [, $err] = YesAsAServiceMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new YesAsAServiceSpec([]),
            'response' => null,
            'result' => new YesAsAServiceResult([]),
        ]);
        [, $err] = YesAsAServiceMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new YesAsAServiceSpec(['step' => 's']),
            'response' => new YesAsAServiceResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new YesAsAServiceResult([]),
        ]);
        [, $err] = YesAsAServiceMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new YesAsAServiceSpec(['step' => 's']),
            'response' => new YesAsAServiceResponse(self::resp(200, ['v' => 1])),
            'result' => new YesAsAServiceResult([]),
        ]);
        [, $err] = YesAsAServiceMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new YesAsAServiceSpec(['step' => 's']),
            'response' => new YesAsAServiceResponse(self::resp(200, ['v' => 2])),
            'result' => new YesAsAServiceResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        YesAsAServiceMakeResponse::call($ctx);
    ...
    {
        $preset = new YesAsAServiceResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new YesAsAServiceSpec([]),
            'response' => new YesAsAServiceResponse([]),
            'result' => new YesAsAServiceResult([]),
        ...
        [$got, $err] = YesAsAServiceMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new YesAsAServiceResult([])]);
        [, $err] = YesAsAServiceMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new YesAsAServiceSpec([]), 'result' => null]);
        [, $err] = YesAsAServiceMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new YesAsAServiceSpec(['step' => 's']),
            'result' => new YesAsAServiceResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new YesAsAServiceOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = YesAsAServiceMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new YesAsAServiceSpec(['step' => 's']),
            'result' => new YesAsAServiceResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new YesAsAServiceOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = YesAsAServiceMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new YesAsAServiceResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new YesAsAServiceSpec([]),
            'result' => new YesAsAServiceResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = YesAsAServiceMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = YesAsAServiceMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new YesAsAServiceError('boom', 'boom');
        $utility->fetcher = function (YesAsAServiceContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new YesAsAServiceSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = YesAsAServiceMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (YesAsAServiceContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = YesAsAServiceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(YesAsAServiceResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        YesAsAServiceMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (YesAsAServiceContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new YesAsAServiceSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = YesAsAServiceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new YesAsAServiceResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new YesAsAServiceSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = YesAsAServiceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = YesAsAServiceMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = YesAsAServiceMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new YesAsAServiceResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, YesAsAServiceDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new YesAsAServiceResult(['ok' => false])]);
        $this->expectException(YesAsAServiceError::class);
        YesAsAServiceDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new YesAsAServiceResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', YesAsAServiceMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        YesAsAServiceMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new YesAsAServiceBaseFeature();
        $b = new YesAsAServiceBaseFeature();
        YesAsAServiceFeatureAdd::call($ctx, $a);
        YesAsAServiceFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): YesAsAServiceBaseFeature
    {
        $f = new YesAsAServiceBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        YesAsAServiceFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): YesAsAServiceContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new YesAsAServiceSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = YesAsAServicePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        YesAsAServicePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new YesAsAServiceResponse(['headers' => null]),
            'result' => new YesAsAServiceResult([]),
        ]);
        YesAsAServiceResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        YesAsAServiceResultBody::call($ctx);
