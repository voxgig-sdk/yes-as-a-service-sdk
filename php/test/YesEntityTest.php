...
class YesEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set YES_AS_A_SERVICE_TEST_YES_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function yes_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("YES_AS_A_SERVICE_TEST_YES_ENTID");
    ...
    if ($env["YES_AS_A_SERVICE_TEST_LIVE"] === "TRUE") {
