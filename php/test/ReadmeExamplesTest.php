...
// YesAsAService SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (YesAsAServiceSDK::test)
...
{
    private const SDK_CLASS = 'YesAsAServiceSDK';
    ...
    private const SDK_BASE = 'yesasaservice_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../yesasaservice_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
