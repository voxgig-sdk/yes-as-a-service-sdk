...
// YesAsAService SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = YesAsAServiceOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(YesAsAServiceOmni::structfix($now, Struct::undef()))
                        !== json_encode(YesAsAServiceOmni::structfix($val, Struct::undef()))) {
