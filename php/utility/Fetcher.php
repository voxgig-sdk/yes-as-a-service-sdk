...
// YesAsAService SDK utility: fetcher

class YesAsAServiceFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; YesAsAServiceSDK/1.0)';
    ...
    public static function call(YesAsAServiceContext $ctx, string $fullurl, array $fetchdef): array
    {
