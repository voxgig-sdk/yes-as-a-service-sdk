...
// YesAsAService SDK utility: make_options

class YesAsAServiceMakeOptions
{
    ...
    public static function call(YesAsAServiceContext $ctx): array
    {
        ...
        //
        // `YesAsAServiceSchema::optspec()` is built from the model:
        ...
        $optspec = YesAsAServiceSchema::optspec();
