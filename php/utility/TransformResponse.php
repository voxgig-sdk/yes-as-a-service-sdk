...
// YesAsAService SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class YesAsAServiceTransformResponse
{
    public static function call(YesAsAServiceContext $ctx): mixed
    {
        ...
        $transform = YesAsAServiceHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
