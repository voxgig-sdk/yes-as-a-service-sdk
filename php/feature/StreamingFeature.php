...
// YesAsAService SDK streaming feature
...
class YesAsAServiceStreamingFeature extends YesAsAServiceBaseFeature
{
    ...
    private function _iterate(YesAsAServiceResult $result): \Generator
    {
    ...
    private function _streamable(YesAsAServiceContext $ctx): bool
    {
