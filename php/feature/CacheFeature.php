...
// YesAsAService SDK cache feature
...
class YesAsAServiceCacheFeature extends YesAsAServiceBaseFeature
{
    ...
    private function _through(YesAsAServiceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
