...
// YesAsAService SDK timeout feature
...
class YesAsAServiceTimeoutFeature extends YesAsAServiceBaseFeature
{
    ...
    private function _with_timeout(YesAsAServiceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(YesAsAServiceContext $_ctx, float $ms): void
    {
        $client = $this->client;
