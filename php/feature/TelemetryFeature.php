...
// YesAsAService SDK telemetry feature
...
class YesAsAServiceTelemetryFeature extends YesAsAServiceBaseFeature
{
    ...
    private function _close(YesAsAServiceContext $ctx, bool $ok): void
    {
