...
// YesAsAService SDK audit feature
...
class YesAsAServiceAuditFeature extends YesAsAServiceBaseFeature
{
    ...
    private function _emit(YesAsAServiceContext $ctx, string $outcome): void
    {
