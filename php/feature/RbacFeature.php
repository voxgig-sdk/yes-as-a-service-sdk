...
// YesAsAService SDK rbac feature
...
class YesAsAServiceRbacFeature extends YesAsAServiceBaseFeature
{
    ...
    private function _required(YesAsAServiceContext $ctx): ?string
    {
    ...
    private function _reject(YesAsAServiceContext $ctx, string $required): void
    {
    ...
    private function _track(YesAsAServiceContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
