...
// YesAsAService SDK proxy feature
...
class YesAsAServiceProxyFeature extends YesAsAServiceBaseFeature
{
    ...
    public function init(YesAsAServiceContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (YesAsAServiceContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
