...
// YesAsAService SDK netsim feature
...
class YesAsAServiceNetsimFeature extends YesAsAServiceBaseFeature
{
    ...
    private function _simulate(YesAsAServiceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(YesAsAServiceContext $ctx, array $applied): void
    {
        $client = $this->client;
