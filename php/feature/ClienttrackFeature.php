...
// YesAsAService SDK clienttrack feature
...
class YesAsAServiceClienttrackFeature extends YesAsAServiceBaseFeature
{
    ...
    public function PostConstruct(YesAsAServiceContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'YesAsAService-SDK';
