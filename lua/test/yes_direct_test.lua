...
describe("YesDirect", function()
  it("should direct-load-yes", function()
    local setup = yes_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-yes", setup.live and "live" or "unit")
...
function yes_direct_setup(mockres)
