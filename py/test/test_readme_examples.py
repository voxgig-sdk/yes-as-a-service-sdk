# YesAsAService SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions YesAsAServiceSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both YesAsAServiceSDK(...) and YesAsAServiceSDK.test(...) become
#      YesAsAServiceSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "yesasaservice_sdk"
_SDK_CLASS = "YesAsAServiceSDK"
