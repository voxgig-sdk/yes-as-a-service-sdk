...
class YesAsAServiceTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = YesAsAServiceTestRunner.getenv("YESASASERVICE_TEST_LIVE")
        override = YesAsAServiceTestRunner.getenv("YESASASERVICE_TEST_OVERRIDE")
        ...
        explain = YesAsAServiceTestRunner.getenv("YESASASERVICE_TEST_EXPLAIN")
