...
class TestYesDirect:
    ...
    def test_should_direct_load_yes(self):
        setup = _yes_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-yes", "live" if setup["live"] else "unit")
        if _skip:
