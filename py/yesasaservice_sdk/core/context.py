...
from yesasaservice_sdk.core.helpers import get_ctx_prop, to_map
...
class YesAsAServiceContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = YesAsAServiceControl()
        ...
        if isinstance(sp, YesAsAServiceSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, YesAsAServiceResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, YesAsAServiceResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return YesAsAServiceError(code, msg, self)
