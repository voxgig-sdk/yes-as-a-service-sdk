...
from yesasaservice_sdk.utility import register

# Load features
from yesasaservice_sdk.feature.base_feature import YesAsAServiceBaseFeature
from yesasaservice_sdk.features import _has_feature, _make_feature
...
class YesAsAServiceSDK:
    ...
    def get_utility(self):
        return YesAsAServiceUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("YesAsAServiceSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Yes(self, data=None) -> "YesEntity":
        ...
        from yesasaservice_sdk.entity.yes_entity import YesEntity
