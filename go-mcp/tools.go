...
type Args struct {
	Entity string         `json:"entity" jsonschema:"yes"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.YesAsAServiceSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "yes-as-a-service_list",
		Description: "List records from YesAsAService. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "yes-as-a-service_load",
		Description: "Load a single record from YesAsAService. " +
...
func runOp(client *sdk.YesAsAServiceSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.YesAsAServiceSDK, name string) (sdk.YesAsAServiceEntity, error) {
	switch strings.ToLower(name) {
	case "yes":
		return client.Yes(nil), nil
