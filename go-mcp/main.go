// Command YesAsAService-mcp is an MCP server exposing the YesAsAService
// SDK as MCP tools.
//
// Two tools are registered:
//
//	YesAsAService_list  — list records of an entity
//	YesAsAService_load  — load a single record of an entity
//
