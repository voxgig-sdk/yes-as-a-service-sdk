...
class YesEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set YES_AS_A_SERVICE_TEST_YES_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def yes_basic_setup(extra)
  ...
  entid_env_raw = ENV["YES_AS_A_SERVICE_TEST_YES_ENTID"]
