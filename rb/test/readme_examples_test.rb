...
#      offline in seeded test mode (YesAsAServiceSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "YesAsAService_sdk.rb")
  SDK_CLASS = "YesAsAServiceSDK"
