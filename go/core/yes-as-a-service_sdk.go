...
func (sdk *YesAsAServiceSDK) OptionsMap() map[string]any {
...
func (sdk *YesAsAServiceSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *YesAsAServiceSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *YesAsAServiceSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *YesAsAServiceSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *YesAsAServiceSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *YesAsAServiceSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("YesAsAServiceSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *YesAsAServiceSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *YesAsAServiceSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("YesAsAServiceSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *YesAsAServiceSDK {
	...
	sdk := NewYesAsAServiceSDK(sdkopts)
	sdk.Mode = "test"
