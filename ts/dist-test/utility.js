...
function envOverride(m) {
    if ('TRUE' === process.env.YES_AS_A_SERVICE_TEST_LIVE ||
        'TRUE' === process.env.YES_AS_A_SERVICE_TEST_OVERRIDE) {
    ...
    m.YES_AS_A_SERVICE_TEST_EXPLAIN = process.env.YES_AS_A_SERVICE_TEST_EXPLAIN || m.YES_AS_A_SERVICE_TEST_EXPLAIN;
    return m;
}
