...
(0, node_test_1.describe)('YesDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.YesAsAServiceSDK({
    ...
    (0, node_test_1.test)('direct-load-yes', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-yes', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.YES_AS_A_SERVICE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.YesAsAServiceSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['YES_AS_A_SERVICE_TEST_YES_ENTID'];
    ...
    const client = new __1.YesAsAServiceSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=YesDirect.test.js.map